# EsoLang-Bench Cross-Language Meta-Programming: Rust -> Befunge-98
...
## Critical Condition: Rust-Only Meta-Programming

- You MUST write Rust helper programs that generate, assemble, or transform
  Befunge-98 programs.
- You may use Rust for generator libraries, emitters, templates, and
  compiler-style workflows.
- The final submitted file must still be a **Befunge-98** program.
- You may keep Rust helper programs and generated artifacts inside this
  workspace.
- You may NOT use Python, JavaScript, C/C++, shell scripts, or any other
  language to generate Befunge-98.
- You may NOT write final Befunge-98 by hand as the primary workflow.
  Befunge-98 should be emitted by Rust.

Recommended workflow:

```bash
rustc gen_E01.rs -O -o gen_E01
./gen_E01 > solutions/E01.b98
